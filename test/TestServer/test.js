...
describe('wordFilter', function() {
  ...
  describe('#filteringTestTwo()', function() {
    it('should return "&ltscript&gt / " when the value is <script>', function() {

    	var result = wordFilter.Filtering("<script>");

      assert.equal("&ltscript&gt / ", result);
    });
  });
   ...
   describe('#filteringTestFive()', function() {
    it('should return "complex one &amp&ltexample all / " when the value is "complex one &<example\nall"', function() {

    	var result = wordFilter.Filtering("complex one &<example\nall");

      assert.equal("complex one &amp&ltexample all / ", result);
    });
  });
